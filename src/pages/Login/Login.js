  ...
  return (
    <div className="min-h-screen bg-gray-100 py-6 flex flex-col mt-5 justify-center sm:py-12">
      <div className="relative py-3 sm:max-w-xl sm:mx-auto">
        <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-blue-900 shadow-lg transform -skew-y-6 sm:skew-y-0 sm:-rotate-12 sm:rounded-3xl"></div>
            ...
            <div className="divide-y divide-gray-200">
              ...
              >
                <div className="relative">
                  ...
                  <label
                    for="email"
                    className="absolute left-0 -top-3.5 text-gray-600 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440  transition-all peer-focus:-top-3.5 peer-focus:text-gray-600 peer-focus:text-sm"
                  >
                    Email Address
                  </label>
                </div>
                ...
                {tError && (
                  <p className="text-sm text-red-500">
                    Please , Your Email or Password is missing .{" "}
                  </p>
                )}
                <div className="relative flex justify-between">
                  ...
                  <Link
                    to="/reset"
                    className="bg-gradient-to-r from-cyan-500 to-blue-500 text-white rounded-md px-4 py-1"
                  >
                    Reset
                  </Link>
                </div>
